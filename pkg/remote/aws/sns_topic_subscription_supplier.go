...
func NewSNSTopicSubscriptionSupplier(provider *AWSTerraformProvider, a alerter.AlerterInterface, client repository.SNSRepository) *SNSTopicSubscriptionSupplier {
